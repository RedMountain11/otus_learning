...
<li>Почему обоим интерфейсам Ethernet на R1 можно назначить один и тот же локальный адрес канала — FE80::1? </li>
<ol> 
    <li> Ответ: потому что LLA должен быть уникальным только в пределах одной сети или канала. Запросы от LLA дальше сети/канала не маршрутизируются, поэтому пересечения идентификаторов вв других сетях\каналах невозможны </li>
</ol>
<li>Какой идентификатор подсети в индивидуальном IPv6-адресе 2001:db8:acad::aaaa:1234/64? </li>
<ol> 
    <li> Ответ: 0000 </li>
</ol>
